...
The results largely confirm what is indicated in the literature (_at least_ 50% data loss). In fact, the average loss or incompleteness exceeds 80% (see below), which roughly means that only 2 out of 10 scheduled observations are collected.
