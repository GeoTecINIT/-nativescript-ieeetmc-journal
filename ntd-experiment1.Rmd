...
author: 
  - Alberto González, Miguel Matey, Carlos Granell, Sven Casteleyn^[[GEOTEC research group](http://geotec.uji.es/), Universitat Jaume I of Castellón, Spain]
...
abstract: |
  This document analyses the reliability and scheduling performance of the self-developed library [NativeScript Task Dispatcher (NTD)](https://github.com/GeoTecINIT/nativescript-task-dispatcher) in a series of Android-based mobile devices as part of the [SyMptOMS project](http://geotec.uji.es/projects/SyMptOMS/). The focus is on the Experiment 1 (simple task scheduling).
...
# Experiment 1: simple task scheduling
