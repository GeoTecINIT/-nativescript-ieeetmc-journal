...
Raw data files are cleaned and merged together into a single file `data/data_ieeetmc`. Total observations: `r n_observations`. Key variables, as explained below, are computed too.
